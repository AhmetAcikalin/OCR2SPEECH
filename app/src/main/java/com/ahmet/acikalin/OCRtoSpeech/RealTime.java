...
import com.ahmet.acikalin.OCRtoSpeech.ExtraViews.FocusBoxView;
import com.ahmet.acikalin.OCRtoSpeech.Imaging.Tools;

import com.ahmet.acikalin.OCRtoSpeech.TessTool.TessAsyncEngine;

import java.util.Locale;

public class RealTime extends Activity implements SurfaceHolder.Callback, View.OnClickListener,
    ...
    public void onPictureTaken(byte[] data, Camera camera) {
        ...
        for(int i=0;i<2;i--) {
            if (TessAsyncEngine.result != "") {
                String toSpeak = TessAsyncEngine.result;
                Toast.makeText(getApplicationContext(), toSpeak, Toast.LENGTH_SHORT).show();
                String utteranceId = this.hashCode() + "";
                tts.speak(toSpeak, TextToSpeech.QUEUE_FLUSH, null, utteranceId);
                TessAsyncEngine.result="";
                break;
            }
