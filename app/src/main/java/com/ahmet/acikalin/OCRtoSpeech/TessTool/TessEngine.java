package com.ahmet.acikalin.OCRtoSpeech.TessTool;

import android.content.Context;
import android.graphics.Bitmap;
import android.util.Log;
import com.ahmet.acikalin.OCRtoSpeech.MainActivity;
...
public class TessEngine {
    ...
    public static final String dat=MainActivity.datapath;
